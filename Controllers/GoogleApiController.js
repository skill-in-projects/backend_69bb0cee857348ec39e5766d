...
router.get('/status', (req, res) => {
    ...
    res.json({
        configured,
        message: configured ? 'Googlev API key is set. You can use Gemini, Maps, and Speech-to-Text.' : 'Google API key is not set. Add GOOGLE_API_KEY in Railway environment variables.'
    });
});
